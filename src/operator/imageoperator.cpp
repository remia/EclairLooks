...
ImageOperator::ImageOperator()
{
    ...
    AddParameter(SliderParameter{ "Opacity", 100.0f, 0.0f, 100.0f, 1.0f , SliderParameter::SliderScale::Linear});
    AddParameter(SliderParameter{ "Contrast", 100.0f, 0.0f, 100.0f, 1.0f , SliderParameter::SliderScale::Linear});
    AddParameter(SliderParameter{ "Color", 100.0f, 0.0f, 100.0f, 1.0f, SliderParameter::SliderScale::Linear });
    AddParameter(SliderParameter{ "DummyLogParam", 100.0f, 1.0f, 10000.0f, 1.0f, SliderParameter::SliderScale::Log });
